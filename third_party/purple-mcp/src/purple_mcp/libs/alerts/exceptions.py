"""Alert-specific exceptions for the alerts library."""

from purple_mcp.type_defs import JsonDict


class AlertsError(Exception):
    """Base exception for all alerts-related errors."""
...
class AlertsConfigError(AlertsError):
    """Configuration-related errors in the alerts system."""

    pass


class AlertsClientError(AlertsError):
    """HTTP/network-related errors when communicating with the alerts API."""
...
class AlertsGraphQLError(AlertsError):
    """GraphQL-specific errors from the alerts API."""
...
class AlertsSchemaError(AlertsError):
    """Schema compatibility errors in the alerts system."""
