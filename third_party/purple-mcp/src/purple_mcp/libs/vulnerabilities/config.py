"""Configuration for Vulnerabilities client."""
...
class VulnerabilitiesConfig(_ProgrammaticSettings):
    """Configuration for the Vulnerabilities client."""

    graphql_url: str = Field(
        ...,
        description="GraphQL endpoint URL for XSPM Vulnerabilities.",
    )
