"""Configuration for Misconfigurations client."""
...
class MisconfigurationsConfig(_ProgrammaticSettings):
    """Configuration for the Misconfigurations client."""

    graphql_url: str = Field(
        ...,
        description="GraphQL endpoint URL for XSPM Misconfigurations.",
    )
