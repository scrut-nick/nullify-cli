"""Misconfiguration-specific exceptions for the misconfigurations library."""

from purple_mcp.type_defs import JsonDict


class MisconfigurationsError(Exception):
    """Base exception for all misconfigurations-related errors."""
...
class MisconfigurationsConfigError(MisconfigurationsError):
    """Configuration-related errors in the misconfigurations system."""

    pass


class MisconfigurationsClientError(MisconfigurationsError):
    """HTTP/network-related errors when communicating with the misconfigurations API."""
...
class MisconfigurationsGraphQLError(MisconfigurationsError):
    """GraphQL-specific errors from the misconfigurations API."""
...
class MisconfigurationsSchemaError(MisconfigurationsError):
    """Schema compatibility errors in the misconfigurations system."""
